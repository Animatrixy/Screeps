var mod = {
    extend: function(){     
        ...
        Creep.action = {
            ...
            defending2: require('./creep.action.defending2'),
            defending3: require('./creep.action.defending3'),
            feeding: require('./creep.action.feeding'), 
            fueling: require('./creep.action.fueling'), 
            guarding: require('./creep.action.guarding'),
            guarding2: require('./creep.action.guarding2'),
            guarding3: require('./creep.action.guarding3'),
            ...
            invading2: require('./creep.action.invading2'),
            invading3: require('./creep.action.invading3'),
        ...
        Creep.behaviour = {
            ...
            soldier: require('./creep.behaviour.soldier'),
            elite: require('./creep.behaviour.elite'),
